...
const appCfg = {
    routes:[
        ...
        {navItem:true, exact:true, path:"/ranch",name:"Ranch",view:<Ranch/>},
        {navItem:true, exact:true, path:"/tournament",name:"Tournament",view:<Tournament/>},
...
const APP_LINKS = {
    messages: "http://localhost/horse_ranch/public/message.php",
    register: "register.php",
    users: "http://localhost/horse_ranch/public/user.php"
};
