...
class RanchS2 extends Component{
    render(){
        return(    
            <Container fluid className="ranch-s2 d-flex minh-50vh align-items-center py-5 border-top border-secondary pt-5">
