...
class TournamentS4 extends Component{
    render(){
        return(    
            <Container fluid className="tournament-s4 d-flex minh-50vh align-items-center py-5 bg-secondary">
